...
export const useSLADataStore = create<SLADataStore>((set, get) => ({
  systemHealth: null,
  alerts: [],
  connectionInfo: null,
  lastUpdated: null,
  ...
  setSystemHealth: (health: SLASystemHealth) => {
    set({ systemHealth: health, lastUpdated: new Date() })
  },
  ...
  restoreFromCache: () => {
    // This method can be used to restore data from cache if needed
